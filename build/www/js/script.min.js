...
var _createClass = (function () {
    ...
    BonziData = {
        ...
        sprite: {
            ...
            clippy_frames: {width: 124, height: 93},
            clippy: {
                idle: 0,
                surf_intro: [824, 850, "idle", 1],
                surf_away: [361, 412, "gone", 1],
                gone: 999,
                shrug_fwd: [199, 211, "shrug_still", 1],
                shrug_still: 211,
                shrug_back: { frames: range(211, 199), next: "idle", speed: 1 },
                earth_fwd: [736, 757, "earth_still", 1],
                earth_still: [757, 783, "earth_still", 1],
                earth_back: { frames: range(757, 736), next: "idle", speed: 1 },
                grin_fwd: [705, 715, 716, 717, 716, 715, 716, 717, 716, "grin_still", 1],
                grin_still: 715,
                grin_back: { frames: range(715, 705), next: "idle", speed: 1 },
            },
            animations: {
                idle: 0,
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "clippy", "pope"], b = 0; b < a.length; b++) {
                        var d;
                        var c = a[b],
                        if (c == 'clippy') {
			    d = { images: ["./img/bonzi/" + c + ".png"], frames: BonziData.sprite.clippy_frames, animations: BonziData.sprite.clippy };
                        } else {
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "clippy", "topjej"];
